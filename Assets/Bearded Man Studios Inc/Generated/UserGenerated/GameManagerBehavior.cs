...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	{
		public const byte RPC_REQUEST_CLIENT_DATA = 0 + 5;
		public const byte RPC_RECIEVE_CLIENT_DATA = 1 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("RequestClientData", RequestClientData);
			networkObject.RegisterRpc("RecieveClientData", RecieveClientData, typeof(byte[]));
		...
		/// Arguments:
		/// </summary>
		public abstract void RequestClientData(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// </summary>
		public abstract void RecieveClientData(RpcArgs args);
